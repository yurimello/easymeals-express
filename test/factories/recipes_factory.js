...
Factory.define('recipe', function (attributes) {
  attributes = attributes || {};
  recipeAttrs = {
    name: attributes.hasOwnProperty('name') ? attributes.name : 'Macarrão bolonhesa',
    category: attributes.hasOwnProperty('category') ? attributes.category : 'massas',
  ...
  if(!this.is('without_ingredients')) {
    recipeAttrs['ingredients'] = [
